    ...
    <div className="calendar-app">
      ...
      <div className="events">
        <div className="event-popup">
          ...
          <textarea placeholder="Enter Event Description (Max 60 characters)"></textarea>
        ...
        <div className="event">
          <div className="event-date-wrapper">
            <div className="event-date">May 15th, 2024</div>
            <div className="event-time">10:30</div>
          </div>
          <div className="event-tex">Meeting with John</div>
